...
const DropdownGarageOutlet = () => {
  ...
  const handleLogout = () => {
    ...
    // Example: Clear authentication tokens and redirect to login page
  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        <span className="h-12 w-12 rounded-full overflow-hidden">
          {/* <Image
            width={112}
            height={112}
            src="/images/garage/garage-icon.png" // Update the path to your garage outlet image/icon
            alt="Garage Outlet"
        ...
        <span className="flex items-center gap-2 font-medium text-dark dark:text-dark-6">
          <span className="hidden lg:block">Downtown Garage</span> {/* Update the garage outlet name */}
      ...
      {dropdownOpen && (
        <div
          className="absolute right-0 mt-2 w-72 flex flex-col rounded-lg border border-stroke bg-white shadow-default dark:border-dark-3 dark:bg-gray-dark z-50"
          role="menu"
          aria-label="Garage Outlet menu"
        >
          <div className="flex items-center gap-2.5 px-5 pb-5.5 pt-3.5">
            ...
            <span className="block">
              ...
              <span className="block font-medium text-dark-5 dark:text-dark-6">
                garage@example.com {/* Optional: Garage outlet email or identifier */}
              </span>
            </span>
          </div>
          <ul className="flex flex-col gap-1 border-y-[0.5px] border-stroke p-2.5 dark:border-dark-3">
            <li>
              <Link
                href="/garage/details" // Update the link to your garage details page
              ...
              >
                ...
                >
                  {/* Example SVG Icon for "View Garage Details" */}
                  <path
                    d="M9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0ZM9 16C5.13401 16 2 12.866 2 9C2 5.13401 5.13401 2 9 2C12.866 2 16 5.13401 16 9C16 12.866 12.866 16 9 16Z"
                    fill="currentColor"
                  />
                  <path
                    d="M9 4C7.34315 4 6 5.34315 6 7C6 8.65685 7.34315 10 9 10C10.6569 10 12 8.65685 12 7C12 5.34315 10.6569 4 9 4Z"
                    fill="currentColor"
                  />
                </svg>
                View Garage Details
            ...
            <li>
              <Link
                href="/garage/manage" // Update the link to your garage management page
                className="flex w-full items-center gap-2.5 rounded-[7px] p-2.5 text-sm font-medium text-dark-4 duration-300 ease-in-out hover:bg-gray-2 hover:text-dark dark:text-dark-6 dark:hover:bg-dark-3 dark:hover:text-white lg:text-base"
              >
                <svg
                  className="fill-current"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  {/* Example SVG Icon for "Manage Garage" */}
                  <path
                    d="M16.92 9.74c.05-.31.08-.63.08-.96s-.03-.65-.08-.96l2.11-1.65a.5.5 0 00.11-.63l-2-3.46a.5.5 0 00-.61-.22l-2.49 1a7.007 7.007 0 00-1.64-.96l-.38-2.65a.5.5 0 00-.5-.42h-4a.5.5 0 00-.5.42l-.38 2.65c-.6.23-1.16.52-1.64.96l-2.49-1a.5.5 0 00-.61.22l-2 3.46a.5.5 0 00.11.63l2.11 1.65c-.05.31-.08.63-.08.96s.03.65.08.96l-2.11 1.65a.5.5 0 00-.11.63l2 3.46a.5.5 0 00.61.22l2.49-1c.48.44 1.04.73 1.64.96l.38 2.65a.5.5 0 00.5.42h4a.5.5 0 00.5-.42l.38-2.65c.6-.23 1.16-.52 1.64-.96l2.49 1a.5.5 0 00.61-.22l2-3.46a.5.5 0 00-.11-.63l-2.11-1.65zM9 11a2 2 0 100-4 2 2 0 000 4z"
                    fill="currentColor"
                  />
                </svg>
                Manage Garage
            ...
            {/* Add more garage-specific options as needed */}
          </ul>
          <div className="p-2.5">
            <button
...
export default DropdownGarageOutlet;